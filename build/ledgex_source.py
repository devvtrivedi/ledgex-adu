...
the six make targets. build_spec_v1_11.py and build_rules_v1_4.py both import
from here. Neither builder may contain a copied invariant table.

Spec v1.11 sec 0.2 "One invariant source" and A-1 "Structural drift prevention".
...
# Verbatim from Engineering Reference Spec v1.11 sec 1.
# --------------------------------------------------------------------------
INVARIANTS = [
    ("I1",
