...
| Rank | Document | Role |
|---|---|---|
| 1 | Engineering Reference Spec v1.49 | Machine-executed build contract. |
...
Engineering Reference Spec v1.49 - executable contract
...
*Generated 2026-09-03 by `build/build_rules.py`. Source of record: `build/ledgex_source.py`.*