...
| Rank | Document | Role |
|---|---|---|
| 1 | Engineering Reference Spec v1.27 | Machine-executed build contract. |
...
Engineering Reference Spec v1.27 - executable contract
...
*Generated 2026-08-14 by `build/build_rules.py`. Source of record: `build/ledgex_source.py`.*