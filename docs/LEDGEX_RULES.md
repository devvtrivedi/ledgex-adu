...
| Rank | Document | Role |
|---|---|---|
| 1 | Engineering Reference Spec v1.48 | Machine-executed build contract. |
...
Engineering Reference Spec v1.48 - executable contract
...
*Generated 2026-09-02 by `build/build_rules.py`. Source of record: `build/ledgex_source.py`.*