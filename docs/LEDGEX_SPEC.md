...
> **This file is the contract and the file of record.** Generated by `build/build_spec_v1_8.py` from `build/ledgex_source.py`. Do not hand-edit. If an instruction in a chat message conflicts with this file, this file wins until amended by an explicit commit. Amendments require a version bump and a row in §12. (I17)
...
| Rank | Document | Role |
|---|---|---|
| 1 | This Spec v1.8 | Machine-executed build contract. |
...
`build/ledgex_source.py` owns `INVARIANTS` and `MAKE_TARGETS`. `build_spec_v1_8.py` and `build_rules_v1_4.py` both import those objects. Neither the markdown nor the PDF is generated from a copied invariant table. Document QA fails if any invariant body or enforcement cell differs between artifacts.
...
Converted verbatim from the v1.8 source document: schema DDL, API contracts, runtime workflow, San José source list, field vocabulary, refusal codes, measurement, environment, change record, subscription commerce and launch dependencies. Section numbering follows the original.
...
Engineering Reference Spec v1.8
...
*Generated 2026-08-05 by `build/build_spec_v1_8.py`. Source of record: `build/ledgex_source.py`.*