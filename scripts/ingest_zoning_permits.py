...
def finish_job_run(conn, job_run_id, status, snapshot_id, rows_in=None, rows_out=None):
...
def load_permits(conn, path, snapshot_id, retrieved_at):
    ...
    try:
        ...
        print(f"  TOTAL UNMATCHED ROWS: {total_unmatched_rows:,} / {rows_in:,} "
              ...
              f"See rows_in/rows_out on this job_run for the durable record.")
        ...
        finish_job_run(conn, job_run_id, "succeeded", snapshot_id, rows_in, matched_rows)
